...
from aster.builders import model_chinese_builder
...
def get_configs_from_exp_dir():
  pipeline_config_path = os.path.join(FLAGS.exp_dir, 'config/trainval_chinese.prototxt')
