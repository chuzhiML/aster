...
def main(_):
    ...
    groundtruth_file = os.path.join(FLAGS.data_dir, 'train.txt')
    ...
    with tf.Session() as sess:
        for index in tqdm(indices):
            ...
            image_path = os.path.join(FLAGS.data_dir, 'images', image_rel_path)
            ...
            example = tf.train.Example(features=tf.train.Features(feature={
                ...
                fields.TfExampleFields.transcript: \
                    dataset_util.int64_list_feature(groundtruth_text_label)
            }))
