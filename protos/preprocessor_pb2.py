...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[aster_dot_protos_dot_label__map__pb2.DESCRIPTOR,])
...
_STRINGFILTERING.fields_by_name['include_charset'].message_type = aster_dot_protos_dot_label__map__pb2._CHARACTERSET
